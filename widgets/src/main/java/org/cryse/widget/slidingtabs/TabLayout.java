 ...
 * {@link #setTitles(List)} } providing it the titles this layout is being used for.
 * <p>
...
public class TabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < mTitleItems.size(); i++) {
            View tabView = null;
            ...
            tabTitleView.setText(mTitleItems.get(i));
    ...
    protected void onAttachedToWindow() {
        ...
        scrollToTab(mInitialPosition, 0);
    }
