...
public class TempFixTextInputLayout extends TextInputLayout {

    private boolean mIsHintSet;
    private CharSequence mHint;

    public TempFixTextInputLayout(Context context) {
        super(context);
    }

    public TempFixTextInputLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
